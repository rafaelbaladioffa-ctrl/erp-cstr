...
export const PERMS = {
  ...
  viewGenerationRule: "core.view_generationrule",
  addGenerationRule: "core.add_generationrule",
  changeGenerationRule: "core.change_generationrule",
  deleteGenerationRule: "core.delete_generationrule",
